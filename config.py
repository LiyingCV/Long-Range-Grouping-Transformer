...
__C.NETWORK.MERGER.TCFORMER = edict()
__C.NETWORK.MERGER.TCFORMER.DIM = 768  
__C.NETWORK.MERGER.TCFORMER.OUT_TOKEN_LENS = [196, 196]
__C.NETWORK.MERGER.TCFORMER.K = 15
__C.NETWORK.MERGER.TCFORMER.NUM_HEAD = 12 
